...
import { cn } from "~/lib/utils"; // 조건부로 className을 추가해주는 유틸리티 함수
...
export default function JobsPage() {
  ...
  const onFilterClick = (key: string, value: string) => {
    ...
    setSearchParams(searchParams, { preventScrollReset: true }); // preventScrollReset: true 옵션을 사용하여 스크롤 위치를 유지
  };
  return (
    <div className="space-y-20">
      <Hero title="Jobs" subtitle="Companies looking for makers" />
      <div className="grid grid-cols-1 xl:grid-cols-6 gap-20 items-start">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:col-span-4 gap-5">
