    ...
    <div className="space-y-10">
      <div className="flex items-center gap-4">
        ...
        <div className="space-y-5">
          <div className="flex gap-2">
            <h1 className="text-2xl font-semibold">Leeji</h1>
          ...
          <div className="flex gap-2 items-center">
            <span className="text-sm text-muted-foreground">@leejidev</span>
      ...
      <div className="flex gap-5">
        {[
          ...
          <NavLink
            end // 경로가 정확히 일치할 때 활성화되도록 설정하는 옵션
            key={item.label}
            className={({ isActive }) =>
              cn(
